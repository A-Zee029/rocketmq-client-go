...
func (m *MockInnerConsumer) GetConsumerRunningInfo(stack bool) *ConsumerRunningInfo {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConsumerRunningInfo", stack)
	ret0, _ := ret[0].(*ConsumerRunningInfo)
	return ret0
}

// GetConsumerRunningInfo indicates an expected call of GetConsumerRunningInfo.
func (mr *MockInnerConsumerMockRecorder) GetConsumerRunningInfo(stack interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetConsumerRunningInfo", reflect.TypeOf((*MockInnerConsumer)(nil).GetConsumerRunningInfo), stack)
}
...
func (m *MockInnerConsumer) RebalanceIfNotPaused() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RebalanceIfNotPaused")
}

// RebalanceIfNotPaused indicates an expected call of RebalanceIfNotPaused.
func (mr *MockInnerConsumerMockRecorder) RebalanceIfNotPaused() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RebalanceIfNotPaused", reflect.TypeOf((*MockInnerConsumer)(nil).RebalanceIfNotPaused))
}

// ResetOffset mocks base method.
func (m *MockInnerConsumer) ResetOffset(topic string, table map[primitive.MessageQueue]int64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ResetOffset", topic, table)
}

// ResetOffset indicates an expected call of ResetOffset.
func (mr *MockInnerConsumerMockRecorder) ResetOffset(topic, table interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResetOffset", reflect.TypeOf((*MockInnerConsumer)(nil).ResetOffset), topic, table)
}
...
// GetBrokerClusterInfo mocks base method.
func (m *MockRMQClient) GetBrokerClusterInfo(ctx context.Context) (*ClusterInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBrokerClusterInfo", ctx)
	ret0, _ := ret[0].(*ClusterInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetBrokerClusterInfo indicates an expected call of GetBrokerClusterInfo.
func (mr *MockRMQClientMockRecorder) GetBrokerClusterInfo(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBrokerClusterInfo", reflect.TypeOf((*MockRMQClient)(nil).GetBrokerClusterInfo), ctx)
}
